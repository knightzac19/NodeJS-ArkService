...
// // initialize
// var parser = new iniReader.IniReader({multiValue:true,hooks: {
// 	write: {
// 		keyValue: function (keyValue, group) {
// 			if (group === 'ServerSettings' && keyValue[0] === 'BanListURL') {
...
// try {
// 	parser.load(path.join(settings.server_config.ark_path,"ShooterGame","Saved","Config","WindowsServer","Game.ini"));
//
// 	// get the config tree
...
// 	parser.write();
//
// 	parser.load(path.join(settings.server_config.ark_path,"ShooterGame","Saved","Config","WindowsServer","GameUserSettings.ini"));
// 	var gameusersettings = parser.getBlock('ServerSettings');
// 	parser.param(['ServerSettings',"BanListURL"],'"'+gameusersettings.BanListURL+'"');
